 ...
 * Creates a dramatic conic-gradient "lamp" glow from above.
 */
export default function LampEffect({
  ...
  return (
    <div
      className={`relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 w-full ${className}`}
    >
      {/* Lamp container */}
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        {/* Animated lamp conic gradient */}
        <motion.div
